...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        ...
        try:
            ...
            logging.info("Escalonamento completo")
            ...
            logging.info("Enconding completo")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Leitura dos dados de treino e teste feita")
            logging.info("Obtendo objeto de preprocessamento")
